...
// Update status to MATCHING
    ...
    //when  some driver accept the request  then the Ride is in Matching state this method will update to ACCEPTED
    ...
    public RideResponse completeRide(String rideId) {
        ...
        // Set final fare (here using estimated fare as actual)
